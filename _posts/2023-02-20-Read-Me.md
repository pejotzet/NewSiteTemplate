...
GitHub gives [for free some minutes of worker time a month](https://github.com/settings/billing).
...
The **activity** of this machine counts to [your processing limits](https://github.com/settings/billing).
